...
+ '.fuse-amp{display:inline-block;font-size:11px;font-weight:700;padding:1px 8px;border-radius:3px;font-family:ui-monospace,monospace}'
+ '.fuse-10{background:rgba(20,83,45,.4);color:#86efac;border:1px solid rgba(20,83,45,.8)}'
+ '.fuse-15{background:rgba(30,58,95,.5);color:#93c5fd;border:1px solid rgba(30,58,95,.9)}'
+ '.fuse-20{background:rgba(113,63,18,.5);color:#fef08a;border:1px solid rgba(113,63,18,.9)}'
+ '.fuse-30{background:rgba(127,29,29,.5);color:#fca5a5;border:1px solid rgba(127,29,29,.9)}'
