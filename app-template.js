...
var BEREICH_GROUPS = [{label:"Scheinwerfer",ids:["A1","A2","B"]},{label:"Motorraum",ids:["C","F","G1","G2","N","S"]},{label:"Lenksäule",ids:["H1","H2","J"]},{label:"Karosserie / Heck",ids:["K","L","M"]},{label:"Armaturenbrett",ids:["D","E","P","Q","R"]},{label:"Instrumente",ids:["U1","U2","V","W","X"]},{label:"Versorgung",ids:["Y","Z1","Z2","30","30B"]}];
